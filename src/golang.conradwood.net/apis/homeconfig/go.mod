...
require (
	...
	golang.conradwood.net/apis/common v1.1.2682
...
require (
	...
	golang.conradwood.net/apis/auth v1.1.2682 // indirect
	...
	golang.conradwood.net/apis/goeasyops v1.1.2682 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.2682 // indirect
