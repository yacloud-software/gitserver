...
require (
	golang.conradwood.net/apis/auth v1.1.2107
	golang.conradwood.net/apis/common v1.1.2107
	golang.conradwood.net/apis/gitbuilder v1.1.2107
	golang.conradwood.net/apis/gitserver v1.1.1702
	golang.conradwood.net/apis/objectauth v1.1.2107
	golang.conradwood.net/apis/slackgateway v1.1.2107
...
require (
	...
	golang.conradwood.net/apis/h2gproxy v1.1.2107 // indirect
	...
	golang.yacloud.eu/apis/urlcacher v1.1.2107 // indirect
