...
require (
	...
	golang.conradwood.net/apis/gitbuilder v1.1.2136
	golang.conradwood.net/apis/gitserver v1.1.1702
	golang.conradwood.net/apis/objectauth v1.1.2136
	golang.conradwood.net/apis/slackgateway v1.1.2136
	golang.conradwood.net/go-easyops v0.1.15954
