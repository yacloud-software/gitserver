...
require (
	...
	golang.conradwood.net/apis/auth v1.1.2796
	golang.conradwood.net/apis/buildrepo v1.1.2796
	golang.conradwood.net/apis/common v1.1.2796
...
require (
	...
	golang.conradwood.net/apis/autodeployer v1.1.2796 // indirect
	golang.conradwood.net/apis/deploymonkey v1.1.2796 // indirect
	...
	golang.conradwood.net/apis/goeasyops v1.1.2796 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.2796 // indirect
