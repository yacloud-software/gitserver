...
require (
	...
	golang.conradwood.net/apis/buildrepo v1.1.3706
	golang.conradwood.net/apis/common v1.1.4021
	golang.conradwood.net/apis/gitbuilder v1.1.3706
	golang.conradwood.net/apis/gitserver v1.1.1702
	golang.conradwood.net/apis/objectauth v1.1.3706
	golang.conradwood.net/apis/slackgateway v1.1.3706
...
require (
	...
	golang.conradwood.net/apis/goeasyops v1.1.4006 // indirect
