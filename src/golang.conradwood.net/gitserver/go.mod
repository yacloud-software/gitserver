...
require (
	...
	golang.conradwood.net/apis/gitbuilder v1.1.2105
	golang.conradwood.net/apis/gitserver v1.1.1702
	golang.conradwood.net/apis/objectauth v1.1.2105
	golang.conradwood.net/apis/slackgateway v1.1.2105
...
require (
	...
	golang.yacloud.eu/apis/urlcacher v1.1.2105 // indirect
